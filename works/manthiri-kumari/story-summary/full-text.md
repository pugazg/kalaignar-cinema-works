...
Authority: `works/manthiri-kumari/transcription/full-text.md`. This derivative preserves the verified canonical Tamil and PDF-page boundaries. It is not a screenplay-scene reconstruction and it does not create immutable dialogue records from reported or quoted synopsis speech.

---

<!-- source: pdf=3 status=verified canonical=works/manthiri-kumari/transcription/full-text.md -->
...
<!-- source: pdf=4 printed=3 status=verified canonical=works/manthiri-kumari/transcription/full-text.md -->
...
<!-- source: pdf=5 printed=4 status=verified canonical=works/manthiri-kumari/transcription/full-text.md -->
