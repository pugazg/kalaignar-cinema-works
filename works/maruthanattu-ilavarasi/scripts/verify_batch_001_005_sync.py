...
V1 applied **8 source-supported corrections** before verification; see \`notes/fidelity-audit.md\`.
...
print('V1 sync QA PASS: 5/21 visual + glyph verified; 8 source corrections; 0 unresolved.')
