...
**Verified scene-text files:** **40 / 50 eligible**  
...
- Batch 007: five-source-page window PDF **60–64**; resumed after blocked `s039`, completed carried-forward `scene-040.md` and `scene-041.md`, then `scene-042.md` through `scene-045.md`; `s046` is carried forward because it continues through PDF 65
...
The five-source-page batching policy never emits a partial scene merely because the iteration boundary is reached. Batch 003 carried `s028` forward; Batch 004 completed it. Batch 004 stopped at blocked `s033`, and Batch 005 resumed with carried-forward `s034`. Batch 005 carried `s036` forward; Batch 006 completed it and then stopped at blocked `s039`. Batch 007 resumed only after that blocked segment and carries `s046` forward because its full span reaches PDF 65.

Post-fidelity rendered-scan rechecks have restored source-visible Raja-label variation that earlier first-pass pages had normalized: PDF 49–50, PDF 53, and now PDF 58–59. On PDF 58–59 the source deliberately alternates `ராஜா:` and `ராசா:`; `scene-040.md` was generated only after those exact printed forms were restored. See `../notes/post-fidelity-corrections.md`.
...
Process the next **five-source-page** window: **PDF 65–69 / printed pp.64–68**. Complete carried-forward `s046` from its verified PDF 64 start through PDF 65, then complete eligible `s047`, `s048`, `s049` and `s050` through PDF 67. Carry `s051` forward because it begins on PDF 67 and continues through PDF 70.
