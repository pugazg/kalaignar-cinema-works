...
- Transcribed to date: PDF **4–23** / printed pages **3–22**.
- Added in this batch: PDF **20–23** / printed pages **19–22**.
- Current canonical page status for PDF 4–23: `draft`.
- Fidelity audit: not yet performed.
- Existing uncertainty markers remain; four additional doubtful readings are explicitly marked in this batch rather than silently guessed.
- Next source page: PDF **24** / printed page **23**.
