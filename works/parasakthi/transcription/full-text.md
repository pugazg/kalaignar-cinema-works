...
- Transcribed to date: PDF **4–19** / printed pages **3–18**.
- Added in this batch: PDF **16–19** / printed pages **15–18**.
- Current canonical page status for PDF 4–19: `draft`.
- Fidelity audit: not yet performed.
- Existing uncertainty markers from earlier batches remain, and five additional doubtful short readings are explicitly marked in this batch rather than silently guessed.
- Next source page: PDF **20** / printed page **19**.
