...
- Transcribed to date: PDF **4–11** / printed pages **3–10**.
- Added in this batch: PDF **8–11** / printed pages **7–10**.
- Current canonical page status for PDF 4–11: `draft`.
- Fidelity audit: not yet performed.
- The previously marked unreadable short span remains on PDF 5 / printed page 4 as `⟦?⟧`.
- Next source page: PDF **12** / printed page **11**.
