...
- total multi-page dialogue records found by full state machine: **24**
- unlabelled continuation source lines owned by an active utterance: **217**
- ordinary source blocks with no active explicit speaker: **37 blocks / 291 lines**
