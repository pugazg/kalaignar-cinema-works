...
4. [`parts/part-04-pdf-64-91.md`](parts/part-04-pdf-64-91.md) — PDF 64–91 / printed pp.56–83 — **corrected-Markdown reconciled at canonical layer; derivative propagation pending from scene 49 onward**.
...
- Canonical parts reconciled from corrected Markdown: **Parts 01–04 / PDF 9–91 / printed pp.1–83**.
...
- Scene 41 contains **38** immutable labelled-dialogue records after recovering two explicitly labelled source utterances; whole-work dialogue count is **1,042**.
...
- Corrected Part 04 now supplies the stable canonical source for the next derivative range, scenes **49–75**. Scene 76 begins on printed p.83 and crosses into Part 05.
- Part 05 remains pending at the canonical layer.
...
- **Canonical corrected reconciliation:** PDF **9–91** / printed pp. **1–83**.
...
- **Next canonical range after that:** Part 05 — PDF **92–112** / printed pp. **84–104**.
