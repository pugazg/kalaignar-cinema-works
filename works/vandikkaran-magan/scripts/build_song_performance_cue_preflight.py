...
terms = [
    'பாட்டு','பாடல்','பாடி','பாடுகிற','பாடிக்','பாடியும்','கீதம்','கீத','பின்னணி','இசை',
    'நடனம்','நடன','நடனமாட','ஆடுகிற','ஆடிக்','ஆடிப்','தாலாட்டு','தாலாட்ட','கூத்து',
    'மேளம்','மேளதாள','தம்பட்டம்','மந்திர','ஜபி','வாசிக்க','நாதஸ்வர'
]
