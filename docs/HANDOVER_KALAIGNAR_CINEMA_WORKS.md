...
- **Maruthanattu Ilavarasi / மருதநாட்டு இளவரசி** — source intake **COMPLETE**, structural mapping **COMPLETE-VERIFIED-CORRECTED**; exact 22-page image-only source uses linear body mapping **PDF 2–22 ↔ logical printed 1–21**, with **no duplicate spreads**; source headings **2–10** with unnumbered opening logical 1–3; Tamil T1 **21/21 COMPLETE-DRAFT**; visual fidelity / final historical glyph **15/21 / 15/21 PASS**; open uncertainties **0**; derivatives **BLOCKED**. Next: logical 16–20 against PDF 17–21.
...
- derivatives: **BLOCKED**.
- V3: **7 source-supported corrections / 1 prepared candidate rejected / 0 unresolved**.
