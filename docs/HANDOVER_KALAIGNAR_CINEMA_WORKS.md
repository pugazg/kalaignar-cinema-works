...
- English translation: **scene 30/63 / 738 verified units**;
- English dialogue coverage: **614 explicit + 13 source-role supplements = 627 dialogue units**;
- English stage/action units: **109**;
- English song-reference units: **2**;
- English cross-page units: **16**;
...
Batch 26–30 source safeguards:

- live source-role authority supersedes the stale prior handoff statement: scene 27 has `ammaiyappan-s027-r001` / `r002` and scene 30 has `ammaiyappan-s030-r001`; all remain context-attributed provenance, not invented printed labels;
- five cross-page immutable records remain single logical owners: scene 26 d010, scene 27 d017, scene 29 d022/d035 and scene 30 d007;
- scene 27 preserves immutable d022 ownership despite its embedded action/additional source tokens;
- scene 29 keeps embedded source-owned actions and frozen comic/irregular wording without upstream repair;
- scene 30 keeps the self-described Purananuru poem inside immutable d007 and translates it only from the frozen source text, with no external reconstruction or duplicate verse ownership;
- the closed song/performance gate has **0 retained occurrences in scenes 26–30**.

**Exact next activity:** translate and source-review archival scenes **31–35** from frozen verified derivatives. The closed source-role layer contains one supplement in this range — `ammaiyappan-s035-r001`; the closed song/performance inventory has no retained occurrence in scenes 31–35. Preserve exact speaker/source-role/page provenance, keep cross-page units whole, and do not modify frozen source evidence.