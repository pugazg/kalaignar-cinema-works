...
- **Naam / நாம்** — active work; intake/map complete; canonical Tamil first pass **PDF 5–34 / 30 of 67**; glyph first-pass **30/67**; verified **0/67**; 2 carried source uncertainties; next PDF 35–39. Source SHA-256 `0f7a54882eb6a5a8f83b29060c771ef18dee2b9e108c8797184de2b97c30b7ad`.
...
- historical-glyph first-pass checked / final verified: **30/67 / 0/67**;
- open source uncertainties: **2**, both inherited from PDF 5/9;
- current batch: `works/naam/transcription/parts/pdf-030-034.md`;
- current source notes: `works/naam/notes/textual-notes-pdf-030-034.md`;
