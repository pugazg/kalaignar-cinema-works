...
- **Naam / நாம்** — active work; intake/map complete; canonical Tamil first pass **PDF 5–29 / 25 of 67**; glyph first-pass **25/67**; verified **0/67**; 2 carried source uncertainties; next PDF 30–34. Source SHA-256 `0f7a54882eb6a5a8f83b29060c771ef18dee2b9e108c8797184de2b97c30b7ad`.
...
**Exact next activity:** Continue canonical Tamil first-pass transcription with PDF 30–34, preserving source order, stable page anchors and page-level historical-glyph checks. Keep all first-pass pages draft/needs-review until the later separate visual-fidelity and final historical-glyph gates pass.
