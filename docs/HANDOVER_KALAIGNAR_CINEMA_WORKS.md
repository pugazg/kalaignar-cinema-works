...
- **Maruthanattu Ilavarasi / மருதநாட்டு இளவரசி** — source intake **COMPLETE**, structural mapping **COMPLETE-VERIFIED-CORRECTED**; linear body mapping **PDF 2–22 ↔ logical printed 1–21**; source headings **2–10** with unnumbered opening logical 1–3; canonical Tamil **21/21 COMPLETE-VERIFIED**; visual fidelity / final historical glyph **21/21 / 21/21 PASS**; open uncertainties **0**; structured derivatives **READY-NEXT**. Next: scene-text derivatives.
...
- V4 final range: **13 source-supported corrections / 0 unresolved**;
- structured derivatives: **NOT STARTED / READY-NEXT**.

**Next:** build source-faithful scene-text derivatives; preserve the unnumbered opening and source headings 2–10.
