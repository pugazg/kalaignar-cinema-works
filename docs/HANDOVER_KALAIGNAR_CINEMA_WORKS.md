...
Ammayappan and Naam remain closed at their recorded checkpoints. **The current active production work is வண்டிக்காரன் மகன்: source/Tamil, scenes, dialogues, characters and the 9-record song/performance layer are closed with QA PASS; English translation is READY-NEXT.**
