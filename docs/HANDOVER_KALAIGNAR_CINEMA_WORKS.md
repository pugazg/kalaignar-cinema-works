...
- **Vandikkaran Magan / வண்டிக்காரன் மகன்** — canonical Tamil **87/87 COMPLETE-VERIFIED**; scenes **72/72 / boundary QA PASS**; dialogues **773 / 38 labels / QA PASS-RECONCILED**; characters **32 / 38/38 / 773/773 / QA PASS**; song/performance **9/9 source-only QA PASS**; English **20/72 VERIFIED / 355 units / 251 dialogue links / 2 performance occurrences**; production batches **15 scenes each**.

Ammayappan and Naam remain closed at their recorded checkpoints. **The current active production work is வண்டிக்காரன் மகன்: English translation is verified through archive scene 20/72 at 355 units, with 15-scene production batches; source/Tamil, scene, reconciled dialogue, character and song/performance authorities remain closed.**
