...
| Maruthanattu Ilavarasi / மருதநாட்டு இளவரசி | **Tamil 21/21 COMPLETE-VERIFIED; visual 21/21; final glyph 21/21; 0 open** | headings **2–10**; unnumbered opening preserved; scene derivatives READY-NEXT | not-started | not-started |
...
- source geometry: **linear PDF 2–22 ↔ logical printed 1–21**;
- visual fidelity / final historical glyph: **21/21 / 21/21 PASS**;
- draft / open uncertainties: **0 / 0**;
- structured derivatives: **NOT STARTED / READY-NEXT**.

Next: build source-faithful scene-text derivatives, preserving the unnumbered opening and source headings 2–10.
