...
| Maruthanattu Ilavarasi / மருதநாட்டு இளவரசி | **Tamil 21/21 COMPLETE-VERIFIED; visual 21/21; final glyph 21/21; 0 open** | **scene derivatives 10/10 COMPLETE-VERIFIED — 1 unnumbered opening + காட்சி 2–10; boundary QA PASS** | not-started | not-started |
...
- visual / final historical glyph: **21/21 / 21/21 PASS**;
- scene-text derivatives: **10/10 COMPLETE-VERIFIED**;
- unnumbered opening / source scenes: **1 / 9 (காட்சி 2–10)**;
- boundary ownership QA: **PASS — 0 gaps / 0 overlaps**;
- dialogue index: **NOT STARTED / READY-NEXT**.

Next: Phase 6 immutable dialogue indexing.
