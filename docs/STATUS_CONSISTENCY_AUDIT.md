...
| Maruthanattu Ilavarasi / மருதநாட்டு இளவரசி | **intake + mapping complete-verified; canonical Tamil not started** | headings **2,3,4,5,6,8,9,10**; opening unnumbered; scene 7 absent | not-started | not-started |
